...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">外卖订单管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>外卖订单列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">外卖订单列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										商家编号
									</label>
									<input type="text" id="shangjiabianhaoSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
									<label>
										美食名称
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('caipinfenlei')">菜品分类<i id="caipinfenleiIcon" class="fa fa-sort"></i></th>
											...
											<th onclick="sort('qucanshijian')">取餐时间<i id="qucanshijianIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('qucanfangshi')">取餐方式<i id="qucanfangshiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#shangjiabianhaoSearch').val() != null && $('#shangjiabianhaoSearch').val() != ''){
				searchForm.shangjiabianhao ="%" +  $('#shangjiabianhaoSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("waimaidingdan/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				shangjiabianhao : searchForm.shangjiabianhao,	
		...
		function setDataRow(item,number){
			...
			var caipinfenleiCell  = document.createElement('td');

						  caipinfenleiCell.innerHTML = item.caipinfenlei; 

			row.appendChild(caipinfenleiCell);
			...
			var qucanshijianCell  = document.createElement('td');

						  qucanshijianCell.innerHTML = item.qucanshijian;


			row.appendChild(qucanshijianCell);
			var qucanfangshiCell  = document.createElement('td');

						  qucanfangshiCell.innerHTML = item.qucanfangshi; 

			row.appendChild(qucanfangshiCell);
		...
		function sh(){
			...
			httpJson("waimaidingdan/update","POST",data,(res)=>{
				if(res.code == 0){
					$('#addRowModal').hide();
					alert("提交成功");
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("waimaidingdan/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"waimaidingdan");
        ...
        function pay(id){
			...
			window.sessionStorage.setItem('tableName',"waimaidingdan");
