						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="caipinfenlei" name="caipinfenlei" class="form-control" v-model="ruleForm.caipinfenlei" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>学号</label>
									...
									<input id="qucanshijian" name="qucanshijian" class="form-control" v-model="ruleForm.qucanshijian" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>取餐方式</label>

									<input id="qucanfangshi" name="qucanfangshi" class="form-control" v-model="ruleForm.qucanfangshi" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>是否审核</label>
