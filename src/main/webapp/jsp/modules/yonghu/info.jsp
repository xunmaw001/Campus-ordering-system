...
<body>
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group  col-md-12">
										<label>地址</label>
										<script id="dizhiEditor" type="text/plain" style="width:800px;height:230px;"></script>
										<script type="text/javascript">
										    //建议使用工厂方法getEditor创建和引用编辑器实例，如果在某个闭包下引用该编辑器，直接调用UE.getEditor('editor')就能拿到相关的实例
										   //相见文档配置属于你自己的编译器
										 var dizhiUe = UE.getEditor('dizhiEditor', {
											toolbars: [
													[
														'undo', //撤销
														'bold', //加粗
										...
										<input type="hidden" name="dizhi" id="dizhi-input">
									</div>
									<div class="form-group  col-md-12">
										<label>审核回复</label>
	...
	<script>
		...
		// 填充富文本框
		function setContent(){
			if(ruleForm.dizhi != null && ruleForm.dizhi != 'null' && ruleForm.dizhi != ''){
				var mes = '' + ruleForm.dizhi;
				var dizhiUeditor = UE.getEditor('dizhiEditor');
				dizhiUeditor.ready(function() {
					dizhiUeditor.setContent(mes);
					dizhiUeditor.setDisabled('fullscreen');
				});
			}
