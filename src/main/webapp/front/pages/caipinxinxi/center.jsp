				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="danjia" id="danjia" placeholder="单价" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">主料</label>
							<div class="layui-input-block">
								<input type="text" name="zhuliao" id="zhuliao" placeholder="主料" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="fenliang" id="fenliang" placeholder="份量" autocomplete="off" class="layui-input">
                                                                                                ...
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">美食介绍</label>
							<div class="layui-input-block">
								<input type="text" name="meishijieshao" id="meishijieshao" placeholder="美食介绍" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
					...
					if (res.data.list.length > 0) {
						...
						carousel.render({
							...
							indicator: "none"
                																								...
                																								http.request(`option/caixifenlei/caixi`,'get',{},(res)=>{
					vue.caixi = res.data
				});
																								// 上传图片
