		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.fuzeren" type="text" name="fuzeren" id="fuzeren" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.shangjiadizhi" type="text" name="shangjiadizhi" id="shangjiadizhi" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">营业执照：</label>
						<div v-if="detail.yingyezhizhao" class="layui-input-block">
							<img id="yingyezhizhaoImg" style="width: 100px;height: 100px;border-radius: 50%;border: 2px solid #EEEEEE;" :src="detail.yingyezhizhao">
