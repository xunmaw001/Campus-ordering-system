...
<body>
    ...
    <div class="about-culture-box">
      <div class="about-culture">
        ...
        <div class="about-culture-piclist">
          <ul>
            <li v-for="(item,index) in caipinxinxiRecommend" v-bind:key="index" @click="jump('../caipinxinxi/detail.jsp?id='+item.id)">
              <img :src="item.tupian?item.tupian.split(',')[0]:''" width="310" height="350" />
              <div class="about-culture-words">
                <h6>{{item.meishimingcheng}}</h6>
                <p></p>
              </div>
            </li>
          </ul>
  ...
  <script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
      ...
      http.request(`caipinxinxi/autoSort`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.caipinxinxiRecommend = res.data.list;
      });
